...
exports.book_detail = asyncHandler(async (req, res, next) => {
  const [bookDetail,bookinstance] = await Promise.all([
  ...
  res.render("book_detail",{title:"Book Detail",book:bookDetail,book_instances:bookinstance});
